##Advanced Lane Finding Writeup (for vehicle detection and tracking writeup see writeup-tracking.md
...
The code for this step is contained in the first code cell of the IPython notebook located in "./pipeline.py" (or in lines # through # of the file called `some_file.py`).  
...
```
This resulted in the following source and destination points: (NOT REALLY)
